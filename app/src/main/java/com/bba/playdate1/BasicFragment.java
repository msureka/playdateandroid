...
public class BasicFragment extends Fragment {
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (mSourceUri == null) {
      ...
      {
        mSourceUri = ProfileFragment.uriImage;//getUriFromDrawableResId(getContext(), R.drawable.sample5);
      }
      else {
        mSourceUri = MainProfileActivity.uriImage;//getUriFromDrawableResId(getContext(), R.drawable.sample5);
      }
