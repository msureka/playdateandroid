    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                postDataParams.put("mobileno",Strmobileno);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(OTPActivity.this);
                ...
                else
                {
                    ...
                    if(Jsonobject.getString("registration_status").equalsIgnoreCase("NEWUSER"))
                    {
                        ...
                        Intent  intent = new Intent(OTPActivity.this, MainProfileActivity.class);
